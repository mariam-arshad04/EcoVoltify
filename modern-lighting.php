...
<!-- for makeup section -->
    <div class="pt-5 lighting-page" style="margin-top: 96px;">
        <h1 style="color: #00441b; font-weight: bolder; margin-left: 100px;">Shop For Modern Lighting</h1>
            ...
            ?>
                <div class="card col-lg-3 col-md-6 col-sm-12">
                    ...
                    <form action="individual_product.php" method="get">
                        ...
                        <img src="<?php echo $row['prd_image'] ?>" class="card-img-top" alt="..." height="270" width="200">
                        <div class="card-body">
